...
- **`/v3/inventories` caps `limit` at 50**, unlike the other endpoints. Paging beyond that follows `meta.nextCursor`, unverified on this account (10 SKUs fits one page).
